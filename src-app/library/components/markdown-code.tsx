...
export const MarkdownCode = (rawProps: Props) => {
	const props = useDefaults(rawProps, { lang: 'plaintext' }, true)
	const { html, lang, raw, error, noCollapse, noPreview, fullHeight, onPreviewCode } = props
