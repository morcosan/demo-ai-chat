export const TOKENS__COLOR = {
	...
	black: { $value: '#18181b', $css: '--ds-color-black' },
	...
	'grey-9': { $value: '#202024', $css: '--ds-color-grey-9' },
	...
	'black-glass-1': { $value: 'rgba(0, 0, 0, 0.02)', $css: '--ds-color-black-glass-1' },
	'black-glass-2': { $value: 'rgba(0, 0, 0, 0.08)', $css: '--ds-color-black-glass-2' },
	'black-glass-3': { $value: 'rgba(0, 0, 0, 0.08)', $css: '--ds-color-black-glass-3' },
	'black-glass-4': { $value: 'rgba(0, 0, 0, 0.16)', $css: '--ds-color-black-glass-4' },
	'black-glass-5': { $value: 'rgba(0, 0, 0, 0.24)', $css: '--ds-color-black-glass-5' },
	'black-glass-6': { $value: 'rgba(0, 0, 0, 0.32)', $css: '--ds-color-black-glass-6' },
	'black-glass-7': { $value: 'rgba(0, 0, 0, 0.40)', $css: '--ds-color-black-glass-7' },
	'black-glass-8': { $value: 'rgba(0, 0, 0, 0.48)', $css: '--ds-color-black-glass-8' },
	'black-glass-9': { $value: 'rgba(0, 0, 0, 0.56)', $css: '--ds-color-black-glass-9' },

	'white-glass-1': { $value: 'rgba(255, 255, 255, 0.02)', $css: '--ds-color-white-glass-1' },
	'white-glass-2': { $value: 'rgba(255, 255, 255, 0.08)', $css: '--ds-color-white-glass-2' },
	'white-glass-3': { $value: 'rgba(255, 255, 255, 0.08)', $css: '--ds-color-white-glass-3' },
	'white-glass-4': { $value: 'rgba(255, 255, 255, 0.16)', $css: '--ds-color-white-glass-4' },
	'white-glass-5': { $value: 'rgba(255, 255, 255, 0.24)', $css: '--ds-color-white-glass-5' },
	'white-glass-6': { $value: 'rgba(255, 255, 255, 0.32)', $css: '--ds-color-white-glass-6' },
	'white-glass-7': { $value: 'rgba(255, 255, 255, 0.40)', $css: '--ds-color-white-glass-7' },
	...
	'text-placeholder': { $ref: { light: 'grey-4', dark: 'grey-5' }, $css: '--ds-color-text-placeholder' },
